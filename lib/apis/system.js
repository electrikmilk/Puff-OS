...
var demo = false;
var log = [];
var cantkill = ["system", "desktop", "videoAPI", "audioAPI", "monitord", "Sound Applet", "Network Applet"];
...
class Process {
  constructor(name, app = false, applet = false) {
    this.id = system.guid();
    this.name = name;
...
$(function() {
  ...
  if (performance.memory) {
    memorymonitor = new Process("monitord");
