...
class Menu {
  ...
  add(id, item, callback) {
    var menu = main.$(".app-menu#menu-" + app.id + " .menubar-menu-container .menubar-menu[data-label='" + this.label + "'] ul");
...
window.onload = function() {
  ...
  if (!appTitle || !appVersion) {
    ...
    setTimeout(function() {
      ...
      // fileMenu.add("undo", "Undo", function() {
      //   document.execCommand("undo");
      // });
      var editMenu = new Menu("Edit", 0);
      ...
      setTimeout(function() {
        ...
        helpMenu.add("report", "Report Bug", function() {
